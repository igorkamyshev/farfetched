...
`mapData` now accepts `{ result, params }` object instead of two separate arguments to be consistent with `.finished.*` [_Events_](https://effector.dev/en/api/effector/event/) and [_Validator_](/api/primitives/validator).
...
`.finished.success` now has a payload of type `{ result: Data, params: Params }` instead of `{ data: Data, params: Params }` to be consistent with `.done` of [_Effect_](https://effector.dev/en/api/effector/effect/).
...
`Validator` now accepts `{ result, params }` object instead of two separate arguments to be consistent with `.finished.*` [_Events_](https://effector.dev/en/api/effector/event/).
...
`mapParams` now accepts `{ result, params }` object instead of two separate arguments to be consistent with `.finished.*` [_Events_](https://effector.dev/en/api/effector/event/) and [_Validator_](/api/primitives/validator).
